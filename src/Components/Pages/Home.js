...
const Home = () => {
  ...
  const NewsArticles = [
    {
      img: "/assets/sec7/1.png",
      text: "9 Easy-to-Ambitious DIY Projects to Improve Your Home",
    },
    {
      img: "/assets/sec7/2.png",
      text: "Serie Shophouse Launch In July, Opportunity For Investors",
    },
    {
      img: "/assets/sec7/3.png",
      text: "Looking for a New Place? Use This Time to Create Your Wishlist",
    },
  ];
  ...
  return (
    <div className=" overflow-hidden">
              ...
              <div className=" d-flex justify-content-center align-items-center">
                <span className=" sec1Form bg-white p-4 rounded-4 d-flex flex-column gap-3">
                  <div className="d-flex justify-content-between flex-wrap pb-3">
                    <Button
                      className=" fw-bold bsrbtn rounded-3 me-1 my-1 "
                      variant="dark"
                      type="submit"
                    >
                      Buy
                  ...
                  <Form>
                    ...
                    >
                      ...
                      />
                      <ImLocation className=" form_icon fs-3 text-info location-icon" />
                    </Form.Group>
                    <Form.Group className="mb-3 position-relative" controlId="formBasicProperty">
                      <Form.Control
                        className="p-3 rounded-4"
                        type="Property"
                        placeholder="Property Type"
                      />
                      <FaBuilding className="form_icon fs-3 text-info location-icon" />
                    ...
                    <Form.Group className="mb-4 position-relative" controlId="formBasicNumber">
                      ...
                      />
                      <RiMoneyDollarBoxFill className=" form_icon fs-3 text-info location-icon" />
      ...
      <section className="section2 py-5">
        <Container>
          <Row>
            ...
            >
              <div className="section2col1 rounded-4 d-flex flex-column p-5 gap-4">
      ...
      <section className="News_div section7 py-5">
        <Container>
          <div  className=" d-flex justify-content-between">
            <h2 className="News_card_text">News & Consult</h2>
            <h3>
              <a className="prop_explore" href="/">
                Explore
                <AiOutlineArrowRight />
          ...
          <div className=" d-flex justify-content-center align-items-center flex-wrap gap-5 py-3">
            {NewsArticles.map((news,index) => (
              <Card key={index} style={{ width: "25rem" }}className="rounded-5 border-0"> 
                <img src={news.img} alt="" />
                <Card.Body className="News_card">
                  <Card.Title className="News_card_text">{news.text}</Card.Title>
                  <h5>
                    <a className="prop_explore" href="/">
                      Read the Article
                      <AiOutlineArrowRight />
